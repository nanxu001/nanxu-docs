...
![构造 DataFrame](/assets/image/code/python/foundation/analysis/pandas/generate-data-frame.png)
...
![读取数据](/assets/image/code/python/foundation/analysis/pandas/read-data.png)
...
![指定读取列](/assets/image/code/python/foundation/analysis/pandas/read-data-specify-columns.png)
...
![数据处理](/assets/image/code/python/foundation/analysis/pandas/data-processing.png)
...
![查看前 n 行数据](/assets/image/code/python/foundation/analysis/pandas/first-n-rows.png)
...
![查看最后 n 行数据](/assets/image/code/python/foundation/analysis/pandas/tail-n-rows.png)
...
![查看数据统计信息](/assets/image/code/python/foundation/analysis/pandas/describe.png)
...
![选择多列](/assets/image/code/python/foundation/analysis/pandas/choose-multiple-columns.png)
...
![基于行号选择行](/assets/image/code/python/foundation/analysis/pandas/choose-columns-by-line-number.png)
...
![基于索引选择行](/assets/image/code/python/foundation/analysis/pandas/choose-columns-by-index.png)
...
![单条件筛选](/assets/image/code/python/foundation/analysis/pandas/filter-by-single-condition.png)
...
![多值匹配筛选](/assets/image/code/python/foundation/analysis/pandas/filter-by-multiple-values.png)
...
![范围筛选](/assets/image/code/python/foundation/analysis/pandas/filter-by-range.png)
...
![多条件组合筛选](/assets/image/code/python/foundation/analysis/pandas/filter-by-and-condition.png)
...
![复杂多条件组合筛选](/assets/image/code/python/foundation/analysis/pandas/filter-by-complex-condition.png)
...
![查看缺失值](/assets/image/code/python/foundation/analysis/pandas/detect-null-values.png)
...
![删除缺失行](/assets/image/code/python/foundation/analysis/pandas/drop-null-rows.png)

运行结果(删除缺失列):

![删除缺失列](/assets/image/code/python/foundation/analysis/pandas/drop-null-columns.png)
...
![填充指定值](/assets/image/code/python/foundation/analysis/pandas/fill-null-with-value.png)
...
![向前填充](/assets/image/code/python/foundation/analysis/pandas/fill-null-ffill.png)
...
![向后填充](/assets/image/code/python/foundation/analysis/pandas/fill-null-bfill.png)
...
![检测全列重复](/assets/image/code/python/foundation/analysis/pandas/detect-duplicates-all-columns.png)
...
![检测指定列重复](/assets/image/code/python/foundation/analysis/pandas/detect-duplicates-subset.png)
...
![删除重复值](/assets/image/code/python/foundation/analysis/pandas/drop-duplicates.png)
...
![查看异常值](/assets/image/code/python/foundation/analysis/pandas/detect-outliers.png)
...
![删除异常值](/assets/image/code/python/foundation/analysis/pandas/remove-outliers.png)
...
![修复异常值](/assets/image/code/python/foundation/analysis/pandas/fix-outliers.png)
...
![单列降序排序](/assets/image/code/python/foundation/analysis/pandas/sort-by-single-column-desc.png)
...
![单列升序排序](/assets/image/code/python/foundation/analysis/pandas/sort-by-single-column-asc.png)
...
![多列组合排序](/assets/image/code/python/foundation/analysis/pandas/sort-by-multiple-columns.png)
...
![单列多指标聚合](/assets/image/code/python/foundation/analysis/pandas/groupby-single-column-multi-agg.png)
...
![多列多指标聚合](/assets/image/code/python/foundation/analysis/pandas/groupby-multi-column-multi-agg.png)
